...
class AppleTab extends StatefulWidget {
  const AppleTab({ Key? key }) : super(key: key);

  @override
  _AppleTabState createState() => _AppleTabState();
}

class _AppleTabState extends State<AppleTab> {
  ...
  Future getNews() async {
    ...
    try {
      isLoading = true;
      response = await _networkService.getRequest("/everything?domains=wsj.com&apiKey=b68e68a90afd4125a8edba60c536822c");
      isLoading = false;
